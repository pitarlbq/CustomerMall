...
namespace WeiXin
{
    ...
    public interface IMessageProcessor
    {
        ...
        /// <returns></returns>
        bool ProcessWifiConnectedEvent(WifiConnectedEventMessage msg, params object[] args);
        ...
        /// <param name="args">参数（用于具体业务传递参数用）</param>
        /// <returns>是否处理成功</returns>
        bool ProcessUploadLocationEvent(LocationReceiveMessage msg, params object[] args);
