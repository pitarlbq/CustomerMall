<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ContractMgr.aspx.cs" Inherits="Web.CangKu.ContractMgr" %>
    ...
    <script>
        ...
        function do_close() {
            parent.do_close_dialog(function () {
                parent.do_choose_contract_done();
            })
        }
    </script>
    <script src="../js/Page/CangKu/CKContractMgr.js?v=<%=base.getToken() %>"></script>
    <style>
        .btn.btn-link {
            padding: 0 !important;
        }
    ...
    <div id="main_form_layout" class="easyui-layout" data-options="fit:true,border:false">
        ...
        <div data-options="region:'center',border:false">
            ...
            <div id="tt_mm">
                ...
                <%if (!string.IsNullOrEmpty(op) && op.Equals("choose"))
                  { %>
