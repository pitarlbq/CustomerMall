...
namespace Web
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            bool result = EncryptHelper.RegisterCompany(GetContextPath(), this.tdCompanyName.Text, this.tdPhoneNumber.Text, this.tbLoginName.Text, this.tbPassword.Text, out errormsg);
