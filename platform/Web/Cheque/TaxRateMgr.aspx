<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="TaxRateMgr.aspx.cs" Inherits="Web.Cheque.TaxRateMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/Cheque/ChequeTaxRateMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
