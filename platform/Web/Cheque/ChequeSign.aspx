<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ChequeSign.aspx.cs" Inherits="Web.Cheque.ChequeSign" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function saveData() {
            ...
            var options = { visit: 'savechequesign', ID: ID, SignOperator: SignOperator, SignRemark: SignRemark, SignTime: SignTime };
