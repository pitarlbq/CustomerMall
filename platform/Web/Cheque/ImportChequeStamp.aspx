<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ImportChequeStamp.aspx.cs" Inherits="Web.Cheque.ImportChequeStamp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function ImportData() {
            ...
            $.messager.progress();
            $('#ff').form('submit', {
                url: "../Handler/ImportChequeHandler.ashx?visit=importchequestamp",
                dataType: "html",
