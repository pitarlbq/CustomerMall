...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Page/Cheque/ChequeOutEdit.js?t=<%=base.getToken() %>"></script>
    <style type="text/css">
        table.info {
            width: 100%;
            margin: 0 auto;
    ...
    <form id="ff" runat="server" method="post" enctype="multipart/form-data">
        <div style="padding: 10px 0; width: 90%; margin: 0 auto;">
            <table class="info" style="margin-bottom: 0px; border-bottom-width: 0px;">
                <tr>
                    <td colspan="4" style="text-align: center; color: red;">提醒信息: 最近三个月进项合计 <span id="tdTotalInCost"></span>&nbsp;&nbsp;&nbsp;&nbsp;已认证 <span id="tdConfirmCost"></span>&nbsp;&nbsp;&nbsp;&nbsp;未认证 <span id="tdNoConfirmCost"></span></td>
                </tr>
                <tr>
                    <td>发票种类</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="easyui-datetimebox" id="tdWriteDate" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>发票编号
            ...
            <div class="easyui-panel" style="height: 350px;">
                ...
                <div id="tt_mm">
                    <a href="javascript:void(0)" onclick="addRow()" class="easyui-linkbutton btnlinkbar" data-options="plain:true,iconCls:'icon-add'">添加</a>
