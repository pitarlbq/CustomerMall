<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ChequeStampMgr.aspx.cs" Inherits="Web.Cheque.ChequeStampMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/Cheque/ChequeStampMgr.js?t=<%=getToken() %>"></script>
    <script>
        function doExport() {
