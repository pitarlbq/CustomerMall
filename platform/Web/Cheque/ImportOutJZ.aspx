<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ImportOutJZ.aspx.cs" Inherits="Web.Cheque.ImportOutJZ" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function ImportData() {
            ...
            $.messager.progress();
            $('#ff').form('submit', {
                url: "../Handler/ImportChequeHandler.ashx?visit=importoutjz",
                dataType: "html",
