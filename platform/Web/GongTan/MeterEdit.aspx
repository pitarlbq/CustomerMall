<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="MeterEdit.aspx.cs" Inherits="Web.GongTan.MeterEdit" %>
        ...
        <div class="table_container">
            <table class="info">
                ...
                <tr>
                    <td>资源编号</td>
                    <td colspan="3">
                        <label runat="server" id="tdProjectNames"></label>
                    </td>
                </tr>
                <tr>
                    <td>仪表种类</td>
                ...
                <tr>
                    <td>收费项目</td>
                    <td>
                        <label runat="server" id="tdChargeSummary"></label>
                    </td>
                    <td>缴费户号</td>
                    <td>
