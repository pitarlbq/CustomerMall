<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="MeterEditPublic.aspx.cs" Inherits="Web.GongTan.MeterEditPublic" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        var hdProjectIDs, hdRoomType, tdChargeSummary, hdChargeIDList;
        $(function () {
        });
        function do_save() {
