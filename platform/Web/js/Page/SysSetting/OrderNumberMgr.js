...
function AssignProject(ID) {
    var iframe = "<iframe id='myFrame' scrolling='auto' frameborder='0' src='../SysSeting/AssignProjectNumber.aspx?OrderNumberID=" + ID + "' style='width:100%;height:" + ($(window).height() - 40) + "px'></iframe>";
