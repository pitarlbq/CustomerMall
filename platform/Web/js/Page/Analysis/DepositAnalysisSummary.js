...
function loadFeedg() {
    ...
    $('#fee_table').treegrid({
        ...
        onBeforeExpand: function (row) {
            //动态设置展开查询的url  
            $("#fee_table").treegrid("options").url = '../Handler/AnalysisHandler.ashx?visit=loaddepositsummarybychargename&RoomID=' + row.RoomID;
            return true;
        },
        ...
        onLoadSuccess: function (node, data) {
            ...
            var visit = "loaddepositsummarybyproject";
            if (visitvalue == "ChargeSummary") {
                visit = "loaddepositsummarybychargename";
            }
            else if (visitvalue == "Project") {
                visit = "loaddepositsummarybyproject";
            }
            else if (visitvalue == "Room") {
                visit = "loaddepositsummarybyroom";
            }
