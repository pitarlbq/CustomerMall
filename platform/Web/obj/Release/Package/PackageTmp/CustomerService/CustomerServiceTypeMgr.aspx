            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td colspan="4" style="text-align: center;">
                        ...
                        <a href="javascript:void(0)" onclick="canceltype()" class="easyui-linkbutton btntoolbar" data-options="plain:true,iconCls:'icon-zuofei'">撤销</a>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table id="tt_table">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'ServiceTypeName'" width="260">名称</th>
