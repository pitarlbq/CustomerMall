<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NavContent4.Master" AutoEventWireup="true" CodeBehind="ActiveMgr.aspx.cs" Inherits="Web.Wechat.ActiveMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/Wechat/ActiveMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
