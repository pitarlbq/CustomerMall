<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="LotteryUserMgr.aspx.cs" Inherits="Web.Wechat.LotteryUserMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Page/Wechat/LotteryUserMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
