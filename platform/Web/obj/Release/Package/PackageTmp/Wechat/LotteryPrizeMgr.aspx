<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="LotteryPrizeMgr.aspx.cs" Inherits="Web.Wechat.LotteryPrizeMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Page/Wechat/LotteryPrizeMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
