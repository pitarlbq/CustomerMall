<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="EditPhraseUser.aspx.cs" Inherits="Web.Wechat.EditPhraseUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        var SurveyID, QuestionID, UserID, content, tdIsDisabled;
        $(function () {
            SurveyID = "<%=this.SurveyID%>";
            QuestionID = "<%=this.QuestionID%>";
            UserID = "<%=this.UserID%>";
            tdIsDisabled = $('#<%=this.tdIsDisabled.ClientID%>');
            createEditor();
            setTimeout(function () {
                setContent();
            }, 1000);
            ...
            <table class="info">
                ...
                <tr>
                    ...
                    <td colspan="3" class="sendtype">
                        <label>
                            <input type="checkbox" runat="server" id="tdIsDisabled" />是</label>
                    </td>
                </tr>
