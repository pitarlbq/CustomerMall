<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="EditChaoBiaoFee.aspx.cs" Inherits="Web.SetupFee.EditChaoBiaoFee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function addfee() {
            ...
            var coefficient = $("#<%=this.tdCoefficient.ClientID%>").textbox("getValue");
            var unit = $("#<%=this.tdUnit.ClientID%>").textbox("getValue");
            var sortorder = $("#<%=this.tdOrderBy.ClientID%>").numberbox("getValue");
            var options = { visit: 'savesummaryfee', id: id, name: name, chargetype: chargetype, endnumber: endnumber, category: category, summaryunitprice: summaryunitprice, coefficient: coefficient, unit: unit, sortorder: sortorder, CompanyID: "<%=Web.WebUtil.GetCompanyID(this.Context)%>", FeeType: 2, IsReading: $("#<%=this.tdIsReading.ClientID%>").combobox("getValue") };
            $.ajax({
                type: 'POST',
                dataType: 'json',
    ...
    <form id="ff" runat="server" method="post">
        <table class="add">
            ...
            <tr>
                ...
                <td>
                    <input id="tdCoefficient" class="easyui-textbox" runat="server" type="text" data-options="required:true,precision:20" />
                </td>
            </tr>
            <tr>
                <td>计量单位
                ...
                <td>
                    <input id="tdUnit" class="easyui-textbox" runat="server" type="text" />
                </td>
                <td>序号
                </td>
                <td>
