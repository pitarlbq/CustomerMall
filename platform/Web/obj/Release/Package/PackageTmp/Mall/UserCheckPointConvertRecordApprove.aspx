<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="UserCheckPointConvertRecordApprove.aspx.cs" Inherits="Web.Mall.UserCheckPointConvertRecordApprove" %>
        ...
        function do_save(status) {
            ...
            $('#ff').form('submit', {
                ...
                onSubmit: function (param) {
                    param.visit = 'approvecheckpointconvert';
                    param.ID = ID;
                    param.Status = status;
                },
        ...
        <div class="table_container">
            <table class="info">
                ...
                <tr>
                    ...
                    <td>岗位积分</td>
                    <td>
                        <label runat="server" id="tdCheckPointValue"></label>
                    </td>
                </tr>
                <tr>
                    <td>状态</td>
