<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="HotSaleMgr.aspx.cs" Inherits="Web.Mall.HotSaleMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/Mall/Product/HotSaleMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
    ...
    <div class="easyui-layout" data-options="fit:true,border:false">
        ...
        <div data-options="region:'center',border:false">
            ...
            <div id="tt_mm">
                ...
                <%} %>
                <%if (base.CheckAuthByModuleCode("1101437"))
                  { %>
