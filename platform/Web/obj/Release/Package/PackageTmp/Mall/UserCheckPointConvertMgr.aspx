<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="UserCheckPointConvertMgr.aspx.cs" Inherits="Web.Mall.UserCheckPointConvertMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>储值管理</title>
    <script src="../js/Page/Mall/Balance/UserCheckPointConvertMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
