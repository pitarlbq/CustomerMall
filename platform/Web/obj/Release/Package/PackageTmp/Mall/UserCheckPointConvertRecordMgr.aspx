<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="UserCheckPointConvertRecordMgr.aspx.cs" Inherits="Web.Mall.UserCheckPointConvertRecordMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>储值管理</title>
    <script src="../js/Page/Mall/Balance/UserCheckPointConvertRecordMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
