<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ImportProperty.aspx.cs" Inherits="Web.CangKu.ImportProperty" %>
    ...
    <script type="text/javascript">
        ...
        function do_export() {
            ...
            $.ajax({
                ...
                data: { visit: 'exportckimportpropertytemplate' },
                success: function (data) {
                    MaskUtil.unmask();
                    if (data.downloadurl) {
