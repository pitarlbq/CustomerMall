<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="AcceptUserMgr.aspx.cs" Inherits="Web.CangKu.AcceptUserMgr" %>
    ...
    <script>
        ...
        function do_close() {
            parent.do_close_dialog(function () {
                parent.do_choose_user_done();
            })
        }
    </script>
    <script src="../js/Page/CangKu/CKAccpetUserMgr.js?v=<%=base.getToken() %>"></script>
    <style>
        .btn.btn-link {
            padding: 0 !important;
        }
