<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="PropertyCategoryMgr.aspx.cs" Inherits="Web.CangKu.PropertyCategoryMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/CangKu/CKPropertyCategoryMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
