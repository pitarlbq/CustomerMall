<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ToChargeAnalysisSummaryV2.aspx.cs" Inherits="Web.Analysis.ToChargeAnalysisSummaryV2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Page/Analysis/ToChargeAnalysisSummaryV2.js?t=<%=base.getToken() %>"></script>
</asp:Content>
