<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="DepositAnalysisSummary.aspx.cs" Inherits="Web.Analysis.DepositAnalysisSummary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Page/Analysis/DepositAnalysisSummary.js?t=<%=base.getToken() %>"></script>
</asp:Content>
