...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function getTableFields() {
            MaskUtil.mask();
            var options = { visit: 'gettablefield', PageCode: PageCode, TableName: TableName };
            $.ajax({
                type: 'POST',
                dataType: 'json',
        ...
        function do_save() {
            ...
            var options = { visit: 'savetablefield', IDs: JSON.stringify(IDList), PageCode: PageCode, SortOrders: JSON.stringify(SortOrderList), FieldIDs: JSON.stringify(FieldIDList), TableName: TableName };
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: '../Handler/SysSettingHandler.ashx',
