<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="MsgMgr.aspx.cs" Inherits="Web.SysSeting.MsgMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/SysSetting/MsgMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
