<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="DepartmentCategoryMgr.aspx.cs" Inherits="Web.Cheque.DepartmentCategoryMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/Cheque/ChequeDepartmentCategoryMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
