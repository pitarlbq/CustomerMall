<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ImportChequeCheck.aspx.cs" Inherits="Web.Cheque.ImportChequeCheck" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function ImportData() {
            ...
            $.messager.progress();
            $('#ff').form('submit', {
                url: "../Handler/ImportChequeHandler.ashx?visit=importchequecheck",
                dataType: "html",
