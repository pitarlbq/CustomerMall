<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ProjectCategoryMgr.aspx.cs" Inherits="Web.Cheque.ProjectCategoryMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/Cheque/ChequeProjectCategoryMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
