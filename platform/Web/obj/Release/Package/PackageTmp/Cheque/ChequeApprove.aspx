<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ChequeApprove.aspx.cs" Inherits="Web.Cheque.ChequeApprove" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function saveData() {
            ...
            var options = { visit: 'savechequeapprove', ID: ID, ApproveOperator: ApproveOperator, ApporveTime: ApporveTime, ApproveRemark: ApproveRemark };
