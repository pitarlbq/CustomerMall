<%@ Page Title="" Language="C#" MasterPageFile="~/Master/ChequeContent.Master" AutoEventWireup="true" CodeBehind="ChequeOutMgr.aspx.cs" Inherits="Web.Cheque.ChequeOutMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/Cheque/ChequeOutMgr.js?t=<%=getToken() %>"></script>
    <script>
        function doExport() {
            var sellerlist = [];
            var productlist = [];
    ...
    <form runat="server">
        <div class="easyui-layout" data-options="fit:true,border:false">
            ...
            <div data-options="region:'center',border:false">
                ...
                <div id="tt_mm">
                    <a href="javascript:void(0)" onclick="addRow()" class="easyui-linkbutton btnlinkbar" data-options="plain:true,iconCls:'icon-add'">申请</a>
                    ...
                    <a href="javascript:void(0)" onclick="doSign()" class="easyui-linkbutton btnlinkbar" data-options="plain:true,iconCls:'icon-save'">开票</a>
