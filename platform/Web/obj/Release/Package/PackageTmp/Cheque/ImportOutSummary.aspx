<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ImportOutSummary.aspx.cs" Inherits="Web.Cheque.ImportOutSummary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function ImportData() {
            ...
            $.messager.progress();
            $('#ff').form('submit', {
                url: "../Handler/ImportChequeHandler.ashx?visit=importoutsummary",
                dataType: "html",
