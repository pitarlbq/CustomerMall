<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="AddInProduct.aspx.cs" Inherits="Web.Cheque.AddInProduct" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/Comm/PinYin.js"></script>
    <script>
        var guid, InSummaryID, ID;
        $(function () {
    ...
    <script type="text/javascript">
        ...
        function saveData() {
            ...
            var options = { visit: 'savechequeinproduct', ID: ID, ProductID: ProductID, ProductName: ProductName, ModelNumber: ModelNumber, Unit: Unit, UnitPrice: UnitPrice, TotalCount: TotalCount, TaxRate: TaxRate, guid: guid, InSummaryID: InSummaryID };
