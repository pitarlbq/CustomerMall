<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ChargeFeePreChargeAllDetail.aspx.cs" Inherits="Web.Charge.ChargeFeePreChargeAllDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Page/Charge/ChargeFeePreChargeAllDetail.js?v=<%=base.getToken() %>" type="text/javascript"></script>
    <style>
        input[type=text] {
            width: 150px;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="easyui-layout" fit="true">
        <div data-options="region:'north'" style="height: 60px; padding: 5px 10px;">
            ...
            <label>
                收费项目:
                <input type="text" class="easyui-combobox" id="tdChargeSummary" />
            </label>
            <label>
                预收项目:
                <input type="text" class="easyui-combobox" id="tdPreChargeSummary" />
            </label>
            <label>
                <a href="#" onclick="SearchPre()" class="easyui-linkbutton btntoolbar" data-options="plain:true,iconCls:'icon-search'">搜索</a>
            </label>
        </div>
        <div data-options="region:'center'" title="">
            ...
            <div id="tt_mm">
                <a href="javascript:void(0)" onclick="chargechongdiroomfee()" class="easyui-linkbutton btnlinkbar" data-options="plain:true,iconCls:'icon-shoufei'">批量冲抵</a>
            </div>
        </div>
    </div>
</asp:Content>
