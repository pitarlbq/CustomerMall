...
function loadtt() {
    $('#tt_table').datagrid({
        ...
        { field: 'PointValue', title: '提现岗位积分', width: 100 },
...
function SearchTT() {
    ...
    $("#tt_table").datagrid("load", {
        "visit": "loadpointwithdrawrecordmgr",
...
function do_approve() {
    ...
    var iframe = "../Mall/UserCheckPointWithDrawRecordApprove.aspx?ID=" + row.ID;
    do_open_dialog('提现审核', iframe);
}