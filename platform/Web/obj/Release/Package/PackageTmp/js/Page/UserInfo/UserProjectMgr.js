...
function getUrl(treeId, treeNode) {
    ...
    var param = "visit=getprojecttree&ID=" + treeNode.id + "&CompanyID=" + CompanyID + "&RoleID=" + RoleId;
...
function loadoperationTree(RoleID, UserID) {
    var options = { visit: 'getprojecttree', CompanyID: CompanyID, RoleID: RoleID, UserID: UserID };
    $.ajax({
        type: 'POST',
        dataType: 'json',
...
function do_save_operation(UserID, RoleID) {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: "../Handler/AuthMgrHandler.ashx",
        data: { visit: 'saveuserprojecttree', IdList: JSON.stringify(idarry), RoleId: RoleID, UserID: UserID },
        success: function (data) {
            MaskUtil.unmask();
            if (data.status) {
