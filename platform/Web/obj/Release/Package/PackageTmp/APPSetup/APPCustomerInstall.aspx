<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APPCustomerInstall.aspx.cs" Inherits="Web.APPSetup.APPCustomerInstall" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            get_data();
            $('#img_logo').attr('src', '<%=Web.WebUtil.GetContextPath()%>' + '/html/images/applogo.png');
        })
        ...
        function get_data() {
            ...
            var options = { visit: 'getappversionbyapptype', APPType: 1, VersionType: mobile_type };
            $.ajax({
                type: 'POST',
                dataType: 'json',
                data: options,
...
<body>
    <form id="form1" runat="server">
        <div class="title_box">
            <div class="cover">
                <%--<img id="img_logo" src="../styles/images/app/appcustomer.png" />--%>
                <img id="img_logo" src="" />
            </div>
            <div class="title">业主端</div>
            <div class="version">
                版本
