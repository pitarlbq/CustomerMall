<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="printchargebackprefee.aspx.cs" Inherits="Web.PrintPage.printchargebackprefee" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        var AddMan;
        var PrintID, PrintNumber, ChargeMan, ChargeTime, Remark, hdChargeMoneyType, FullName, MoneyDaXie, pageWidth, pageHeight, hdOrderNumberID, RoomFullName, RoomOwnerName, ChargeID, RoomIDs, Cost;
        $(function () {
    ...
    <script src="../js/Page/Print/printchargebackprefee.js?v=<%=base.getToken() %>"></script>
    ...
    <script type="text/javascript">
        ...
        function startPrint() {
            ...
            var url = "printchargebackprefeeview.aspx?PrintID=" + PrintID + "&PageWidth=" + pageWidth + "&PageHeight=" + pageHeight;
            iframe.src = url;
        ...
        <div class="table_container">
            ...
            <div class="wrap" id="print_wrap">
                <div class="content" id="print_content">
                    ...
                    <table class="sfxm">
                        <thead>
                            ...
                            <tr>
                                <th colspan="5" class="systitle">
                                    <label id="tdFirstTitle" runat="server"></label>
                                </th>
                            </tr>
                            <tr>
                                <th colspan="5" class="sksj">
                ...
                <input value="<%=this.FullName %>" id="tdRoomFullName" type="text" />
                                ...
                                <th colspan="2" class="khxm">客户名称: 
                <input value="<%=this.OwnerName %>" id="tdRoomOwnerName" type="text" />
                                </th>
                            </tr>
                            <tr class="haveborder">
                                <th style="width: 20%">付款项目
                                </th>
                                <th style="width: 20%">当前金额
                                </th>
                                <th style="width: 20%">付款金额
                                </th>
                                <th style="width: 20%">账户余额
                                </th>
                                <th style="width: 20%">扣款说明
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <asp:Repeater runat="server" ID="rptProject">
                                <ItemTemplate>
                                    <tr class="haveborder">
                                        <td id="summaryname_<%# Container.ItemIndex + 1%>"><%# Eval("ChargeFeeSummaryName")%>
                                        </td>
                                        <td id="totalbalance_<%# Container.ItemIndex + 1%>"><%# (decimal)Eval("ChargeFeeCurrentBalance")%>
                                        </td>
                                        <td>
                                            <input type="text" data-index="<%# Container.ItemIndex + 1%>" class="realcost realcost_<%# Container.ItemIndex + 1%>" value='<%# (decimal)Eval("RealCost")%>' style="width: 100%; text-align: center; border: 0px; border-bottom: solid 1px #000;" />
                                        </td>
                                        <td data-value="<%# (decimal)Eval("TotalRestBalance")%>" id="restbalance_<%# Container.ItemIndex + 1%>"><%# Web.WebUtil.FormatMoney((decimal)Eval("TotalRestBalance"))%>
                                        </td>
                                        <td>
                                            <input type="text" id="remark_<%# Container.ItemIndex + 1%>" style="width: 100%; text-align: center; border: 0px;" /></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                        </tbody>
                                ...
                                <th colspan="7">
                                    <table class="skxx">
                                        <tr>
                                            ...
                                            ￥<span id="TotalCost"><%= Web.WebUtil.FormatMoney(this.money) %></span>
                                            </td>
