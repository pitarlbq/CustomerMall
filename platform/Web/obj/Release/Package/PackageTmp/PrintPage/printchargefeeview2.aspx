<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="printchargefeeview2.aspx.cs" Inherits="Web.PrintPage.printchargefeeview2" %>
                    ...
                    $.each(message.list, function (index2, data) {
                        ...
                        $.each(data.list, function (index, item) {
                            if (index % totallines == 0) {
                                ...
                                $html += '</tr>';
                                $html += '<tr>';
                                $html += '<th colspan="' + totalcolumns + '" class="sksj finalfont" style="font-size:' + data.PrintFont + ';">';
                            ...
                            if (data.IsPrintTotalRealCost) {
                                if (PrintID > 0) {
                                    ...
                                    $html += '<td>' + (TotalRealCost < 0 ? 0 : toThousands(TotalRealCost)) + '</td>';
                                }
                                else {
                            ...
                            if ((index + 1) % totallines == 0 || index == (data.list.length - 1)) {
                                ...
                                $html += '<tr>';
                                $html += '<td style="width:40%;border-left:none; text-align:left;">收款合计：';
                                $html += data.printhistory.CostCapital + '</td>';
                                $html += '<td style="width:60%;border-right:none;text-align:left;">';
                                if (pagetotalcount > 1) {
                                ...
                                if (Number(data.printhistory.RealMoneyCost2) > 0 && data.PrintChargeTypeCount == 2) {
                                    ...
                                    $html += '￥' + (Number(data.printhistory.RealMoneyCost2) < 0.00 ? 0 : toThousands(data.printhistory.RealMoneyCost2)) + '&nbsp;&nbsp;&nbsp;&nbsp;';
                                }
                                if (Number(data.printhistory.DiscountMoney) > 0) {
                                    $html += '优惠: ';
                                    $html += '￥' + (Number(data.printhistory.DiscountMoney) < 0.00 ? 0 : toThousands(data.printhistory.DiscountMoney));
                                }
                                $html += '</td>';
                                ...
                                if (data.show_sign && false) {
                                    ...
                                    $html += '客户签名: <div style="border-bottom:solid 0px #000;width:100px;display:inline-block;height:15px;margin-right:10px;"></div>';
                                    $html += '</td>';
                                }
                                else {
