<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="EditSourceOut.aspx.cs" Inherits="Web.Setup.EditSourceOut" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function saveResource() {
            ...
            var options = { visit: 'editresourceout', ID: ID, CarrierID: CarrierID, MoveCost: MoveCost, Count: Count, OutTime: OutTime, Remark: Remark, AddMan: AddMan, SpecID: SpecID };
            $.ajax({
                type: 'POST',
                dataType: 'json',
    ...
    <form id="ff" runat="server">
        <table class="add">
            <tr>
                ...
                <td>
                    <input class="easyui-textbox" id="tdOrderNumber" runat="server" data-options="required:true,disabled:true" />
                </td>
                <td>库位
                </td>
                <td>
