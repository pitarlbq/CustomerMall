...
{
    public partial class FeeParamsSetup : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            var submenus = Foresight.DataAccess.SysMenu.GetSysModulesForUserByUserId(WebUtil.GetUser(this.Context).UserID).Where(p => p.ParentID == 120);
