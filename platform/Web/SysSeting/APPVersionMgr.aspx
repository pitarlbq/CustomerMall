<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="APPVersionMgr.aspx.cs" Inherits="Web.SysSeting.APPVersionMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/SysSetting/APPVersionMgr.js?v=<%=base.getToken() %>"></script>
</asp:Content>
