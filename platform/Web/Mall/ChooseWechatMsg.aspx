<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ChooseWechatMsg.aspx.cs" Inherits="Web.Mall.ChooseWechatMsg" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        var type = 1, msgtype = 1, singleselect;
        $(function () {
    ...
    <script src="../js/Page/Mall/Business/ChooseWechatMsg.js?v=<%=base.getToken()%>"></script>
</asp:Content>
