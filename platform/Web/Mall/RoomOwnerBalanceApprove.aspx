<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="RoomOwnerBalanceApprove.aspx.cs" Inherits="Web.Mall.RoomOwnerBalanceApprove" %>
        ...
        function do_approve(BalanceStatus) {
            ...
            $('#ff').form('submit', {
                ...
                onSubmit: function (param) {
                    param.visit = 'savemallroomownerbalancestatus';
