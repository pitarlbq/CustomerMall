...
namespace Web.Mall
{
    public partial class UserCheckPointConvertRecordApprove : BasePage
    {
        public int ID = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (ID > 0)
            {
                var data = Foresight.DataAccess.Mall_PointCovertRecord.GetMall_PointCovertRecord(ID);
                SetInfo(data);
                return;
            }
        }
        private void SetInfo(Foresight.DataAccess.Mall_PointCovertRecord data)
        {
            ...
            this.tdCheckPointValue.InnerHtml = data.CheckPointValue.ToString();
