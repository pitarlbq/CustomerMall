<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ImportDevice.aspx.cs" Inherits="Web.RoomResource.ImportDevice" %>
        ...
        function do_save() {
            ...
            $('#ff').form('submit', {
                ...
                onSubmit: function (param) {
                    param.visit = "importdevicesource"
                },
                dataType: "html",
