<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="InMgr.aspx.cs" Inherits="Web.Setup.InMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/DKSetup/loadintt.js?v=<%=base.getToken() %>"></script>
    <style>
        label.searchlabel {
            margin: 10px;
        }
