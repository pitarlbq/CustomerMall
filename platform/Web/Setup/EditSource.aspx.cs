...
namespace Web.Setup
{
    public partial class EditSource : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.tdStartTime.Value = DateTime.Now.ToString("yyyy-MM-dd");
            this.tdEndTime.Value = DateTime.Now.AddDays(30).ToString("yyyy-MM-dd");
        }
