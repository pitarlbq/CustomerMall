<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="CarrierBalanceMgr.aspx.cs" Inherits="Web.Setup.CarrierBalanceMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        var AddMan = "<%=Web.WebUtil.GetUser(this.Context).RealName%>";
    </script>
    <script src="../js/Page/DKSetup/CarrierBalanceMgr.js?v=<%=base.getToken() %>"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div class="easyui-layout" data-options="fit:true,border:false">
        <div data-options="region:'north',border:false" style="height: 50px; font-size: 12px;">
            ...
            <label style="">
                计算状态:
                <select class="easyui-combobox" id="tdCarrierChargeStatus">
