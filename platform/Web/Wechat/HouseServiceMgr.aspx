<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="HouseServiceMgr.aspx.cs" Inherits="Web.Wechat.HouseServiceMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Page/Wechat/HouseServiceMgr.js?v=<%=base.getToken() %>"></script>
    <style>
        .searcharea label {
            padding: 0px 5px;
        }
            ...
            <div class="easyui-layout" data-options="fit:true,border:false">
                ...
                <div data-options="region:'center',border:false,fit:true">
                    ...
                    <div id="tt_mm">
                        ...
                        <%} %>
                        <%if ((base.CheckAuthByModuleCode("1101345") && this.type == 2) || type == 1)
                          { %>
