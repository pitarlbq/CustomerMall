<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="MsgCategoryMgr.aspx.cs" Inherits="Web.Wechat.MsgCategoryMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/Wechat/MsgCategoryMgr.js?v=<%=base.getToken()%>"></script>
</asp:Content>
    ...
    <div class="easyui-layout" data-options="fit:true,border:false">
        ...
        <div data-options="region:'center',border:false">
            ...
            <div id="tt_mm">
                ...
                <%} %>
                <%if (base.CheckAuthByModuleCode("1101342"))
                  { %>
