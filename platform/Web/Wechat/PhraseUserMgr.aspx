<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="PhraseUserMgr.aspx.cs" Inherits="Web.Wechat.PhraseUserMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        var type = 1, SurveyType = 3;
        $(function () {
            type = Number("<%=this.type%>");
        })
    </script>
    <script src="../js/Page/Wechat/PhraseUserMgr.js?v=<%=base.getToken() %>"></script>
    <style>
        .searcharea label {
            padding: 0px 5px;
        }
    ...
    <div class="easyui-layout" data-options="fit:true,border:false">
        <div data-options="region:'west',border:false" style="width: 260px;">
            ...
            <div class="easyui-panel" style="max-height: 90%;">
                <div>
                    <%if ((base.CheckAuthByModuleCode("1101358") && this.type == 2) || type == 1)
                      { %>
                    ...
                    <%} %>
                    <%if ((base.CheckAuthByModuleCode("1101359") && this.type == 2) || type == 1)
                      { %>
                    ...
                    <%} %>
                    <%if ((base.CheckAuthByModuleCode("1101360") && this.type == 2) || type == 1)
                      { %>
            ...
            <div class="easyui-layout" data-options="fit:true,border:false">
                ...
                <div data-options="region:'center',border:false,fit:true">
                    ...
                    <div id="tt_mm">
                        ...
                        <%} %>
                        <%if ((base.CheckAuthByModuleCode("1101468") && this.type == 2) || type == 1)
                          { %>
                        ...
                        <%} %>
                        <%if ((base.CheckAuthByModuleCode("1101361") && this.type == 2) || type == 1)
                          { %>
