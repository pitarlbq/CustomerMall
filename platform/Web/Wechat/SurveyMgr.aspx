<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="SurveyMgr.aspx.cs" Inherits="Web.Wechat.SurveyMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Page/Wechat/SurveyMgr.js?v=<%=base.getToken() %>"></script>
    <style>
        .searcharea label {
            padding: 0px 5px;
        }
    ...
    <div class="easyui-layout" data-options="fit:true,border:false">
        <div data-options="region:'west',border:false" style="width: 260px;">
            ...
            <div class="easyui-panel" style="max-height: 90%;">
                <div>
                    <%if ((base.CheckAuthByModuleCode("1101346") && this.type == 2) || type == 1)
                      { %>
                    ...
                    <%} %>
                    <%if ((base.CheckAuthByModuleCode("1101347") && this.type == 2) || type == 1)
                      { %>
                    ...
                    <%} %>
                    <%if ((base.CheckAuthByModuleCode("1101348") && this.type == 2) || type == 1)
                      { %>
        ...
        <div data-options="region:'center',border:false,fit:true" style="width: 260px;">
            <div class="easyui-layout" data-options="fit:true,border:false">
                ...
                <div data-options="region:'center',border:false">
                    ...
                    <div id="tt_mm">
                        ...
                        <%} %>
                        <%if ((base.CheckAuthByModuleCode("1101462") && this.type == 2) || type == 1)
                          { %>
                        ...
                        <%} %>
                        <%if ((base.CheckAuthByModuleCode("1101349") && this.type == 2) || type == 1)
                          { %>
