<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="OrderAnalysis.aspx.cs" Inherits="Web.MallAnalysis.OrderAnalysis" %>
    ...
    <script>
        ...
        function load_vue() {
            content = new Vue({
                ...
                data: {
                    form: {
                        order_readypay_count: '0笔',
                        order_readyship_count: '0笔',
                        order_complete_count: '0笔',
                        order_total_count: '0笔',
                        order_product_count: '0个',
                ...
                methods: {
                    getdata: function (item) {
                        ...
                        var options = { visit: 'getmallorderanalysis', StartTime: StartTime, EndTime: EndTime };
                        MaskUtil.mask();
                        $.ajax({
                            type: 'POST',
                            dataType: 'json',
            ...
            <div v-cloak id="fieldcontent">
                <div class="customer_container">
                    <div class="customer_item">
                        ...
                        <div class="count">{{form.order_readypay_count}}</div>
                    </div>
                    <div class="customer_item">
                        <div class="title">待发货</div>
                        <div class="count">{{form.order_readyship_count}}</div>
                    </div>
                    <div class="customer_item">
                        <div class="title">已完成</div>
                        <div class="count">{{form.order_complete_count}}</div>
                    </div>
                </div>
                <div class="customer_container">
                    <div class="customer_item">
                        <div class="title">订单数</div>
                        <div class="count">{{form.order_total_count}}</div>
                    </div>
                    <div class="customer_item">
                        <div class="title">成交商品数</div>
                        <div class="count">{{form.order_product_count}}</div>
                    </div>
                    <div class="customer_item">
                        <div class="title">成交额</div>
                        <div class="count">{{form.order_total_cost}}</div>
                    </div>
                </div>
            </div>
