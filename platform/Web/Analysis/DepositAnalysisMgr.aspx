<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NavContent4.Master" AutoEventWireup="true" CodeBehind="DepositAnalysisMgr.aspx.cs" Inherits="Web.Analysis.DepositAnalysisMgr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div class="easyui-tabs" id="CostTab" style="width: 100%; height: 99%; border: none;" data-options="tabHeight:35">
        <div title="明细表" style="padding: 0px">
            <input type="hidden" value="DepositAnalysisDetails.aspx" />
            <iframe src="" style="width: 100%; height: 99%; border: 0"></iframe>
        </div>
        <div title="汇总表" style="padding: 0px">
            <input type="hidden" value="DepositAnalysisSummary.aspx" />
            <iframe src="" style="width: 100%; height: 99%; border: 0"></iframe>
        </div>
    </div>
</asp:Content>
