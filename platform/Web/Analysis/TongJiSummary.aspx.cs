...
{
    public partial class TongJiSummary : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            var submenus = Foresight.DataAccess.SysMenu.GetSysModulesForUserByUserId(WebUtil.GetUser(this.Context).UserID).Where(p => p.ParentID == 118);
