<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="SetupFee_ChaoBiao.aspx.cs" Inherits="Web.SetupFee.SetupFee_ChaoBiao" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Page/SetupFee/SetupFee_ChaoBiao.js?v=<%=base.getToken() %>"></script>
</asp:Content>
