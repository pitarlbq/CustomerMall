<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="SetupFee_Contract.aspx.cs" Inherits="Web.SetupFee.SetupFee_Contract" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Page/SetupFee/SetupFee/SetupFee_Contract.js?v=<%=base.getToken() %>"></script>
    <style type="text/css">
        table.projecttable {
            width: 100%;
