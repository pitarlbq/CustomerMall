        ...
        <div data-options="region:'center',border:false">
            <div class="easyui-tabs" id="RoomSourceTab" style="width: 100%; height: 99%; border: none;" data-options="tabHeight:35">
                ...
                <div title="合同租户信息" style="padding: 0px">
                    <input type="hidden" value="EditRoomResource_Contract.aspx?RoomID=<%=Request.QueryString["RoomID"] %>" />
                    <iframe src="" style="width: 100%; height: 99%; border: 0"></iframe>
                </div>
                <%--<div title="租户信息" style="padding: 0px">
                    <input type="hidden" value="EditRoomResource_Rent.aspx?RoomID=<%=Request.QueryString["RoomID"] %>" />
                    <iframe src="" style="width: 100%; height: 99%; border: 0"></iframe>
                </div>--%>
                <div title="关联资源" style="padding: 0px">
                    <input type="hidden" value="EditRoomResource_Relation.aspx?RoomID=<%=Request.QueryString["RoomID"] %>" />
                    <iframe src="" style="width: 100%; height: 99%; border: 0"></iframe>
                </div>
            </div>
        </div>
