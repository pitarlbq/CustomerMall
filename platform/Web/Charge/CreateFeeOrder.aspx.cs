...
{
    public partial class CreateFeeOrder : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                var data = Foresight.DataAccess.RoomFeeOrder.GetTopRoomFeeOrder();
                if (data != null)
                {
                    this.StartTime = data.ChargeEndTime != DateTime.MinValue ? data.ChargeEndTime.ToString("yyyy-MM-dd HH:mm:ss") : "";
                }
            }
        }
